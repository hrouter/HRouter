...
internal object Const {
    ...
    private const val ROOT_PACKAGE = "com.lq.annotation.route"

    private const val INTERCEPTOR_PACKAGE = "com.lq.annotation.interceptor"

    private const val DEGRADE_PACKAGE = "com.lq.annotation.degrade"

    private const val DEEPLINK_PACKAGE = "com.lq.annotation.deeplink"

    private const val META_PACKAGE = "com.lq.annotation.data"

    private const val AUTO_WIRED_TYPE_ADAPTER = "com.lq.core.autowired"
    ...
    val AutoWiredQualifiedName = AutoWired::class.qualifiedName!!
    ...
    const val SAFE_LOAD_PATH = "com.lq.core.util"
