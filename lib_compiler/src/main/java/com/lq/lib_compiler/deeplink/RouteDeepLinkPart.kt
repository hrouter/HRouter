package com.lq.lib_compiler.deeplink
...
import com.lq.lib_compiler.util.getModuleNameCapitalize
...
internal class RouteDeepLinkPart (private val environment: SymbolProcessorEnvironment): ProcessorPart {
