...
import com.lq.core.interceptor.RouteRequest
import com.lq.core.navigate.NavigateContext

internal class HRouterDelegate(
    ...
    internal fun buildNavigateContext(degradeContext: DegradeContext? = null): NavigateContext {
        val context =
            NavigateContext(path, bundle, RouteContext(RouteRequest(path, bundle), 0), launcher, enterAnim, exitAnim, degradeContext)
        return context
    }
